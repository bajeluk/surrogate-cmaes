...
clear pdfNames
pdfNames = {fullfile(plotResultsFolder, 'crit5D'), ...
            fullfile(plotResultsFolder, 'crit20D')};
...
clear pdfNames
pdfNames = {fullfile(plotResultsFolder, 'pop5D'), ...
            fullfile(plotResultsFolder, 'pop20D')};
...
clear pdfNames
pdfNames = {fullfile(plotResultsFolder, 'alg5D'), ...
            fullfile(plotResultsFolder, 'alg10D'), ...
...
han = relativeFValuesPlot(data, ...
                              'DataNames', datanames, 'DataDims', funcSet.dims, ...
                              'DataFuns', funcSet.BBfunc, 'Colors', colors, ...
                              'PlotFuns', plotFuns, 'PlotDims', funcSet.dims, ...
                              'AggregateDims', true, 'OneFigure', false, ...
