...
ceda_bbob = fullfile(exppath, 'EDA_BBOB/CEDA_5');
...
ceda_traj = fullfile(exppath, 'EDA_SAGAS/CEDA_traj_2');
...
% load data
dataFoldersBBOB = { ceda_bbob, ...
  egna_bbob1, ...
  egna_bbob2, ...
  gauss_bbob, ...
  cmaes_bbob};
dataFoldersTraj = { ceda_traj, ...
  egna_traj, ...
  gauss_traj, ...
  cmaes_traj};
...
ceda_bbob_Id = getStructIndex(settingsBBOB, findSet);
clear findSet
...
ceda_traj_Id = getStructIndex(settingsTraj, findSet);
clear findSet
...
% extract data
ceda_bbob_data  = evalsBBOB(:, :, ceda_bbob_Id);
...
ceda_traj_data  = evalsTraj(:, :, ceda_traj_Id);
...
ceda_bbobCol = [255,   0,   0];  % light red (#ff0000)
ceda_trajCol = [255,   0,   0];  % light red (#ff0000)
...
for plotDims = [2, 5, 10]
  ...
  colors = [ceda_bbobCol; egna_bbob1Col; egna_bbob2Col; ...
      gauss_bbobCol; cmaes_bbobCol] / 255;
      % , ceda_trajCol; egna_trajCol; gauss_trajCol; cmaes_trajCol]' / 255;
  markers = {ceda_bbobMark, egna_bbob1Mark, egna_bbob2Mark, ...
...
colors = [ceda_trajCol; egna_trajCol; gauss_trajCol; cmaes_trajCol] / 255;
markers = {ceda_trajMark, egna_trajMark, gauss_trajMark, cmaes_trajMark};
...
han = relativeFValuesPlot(data, ...
                              ...
                              'AggregateDims', false, 'OneFigure', false, ...
                              'Statistic', 'quantile', ... 'quantile', ... % @median, ...
                              'Quantiles', [true, false(1,3)], ...
                              'AggregateFuns', false, ...
                              'LineSpecification', '-', ...
                              'LineWidth', [ 2, ones(1,3) ], ...
