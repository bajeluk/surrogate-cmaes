...
for plotDims = [5, 10, 20]
  ...
  colors = [scmaes_gpCol; dts005Col; dts_adaptCol; maesCol; gpopCol;
      repmat(gray, 7, 1)]/255;
  markers = {scmaesMark, dts005Mark, dts_adaptMark, maesMark, gpopMark, ...
      cmaesMark, cmaes2popMark, saacmesMark, lmmMark, bobyqaMark, smacMark, fminconMark, fmincon_pureMark};  
...
for plotDims = [5, 10, 20]
  ...
  colors = [scmaes_gpCol; dts005Col; dts_adaptCol; maesCol; gpopCol; ...
      cmaesCol; cmaes2popCol; saacmesCol; lmmCol; bobyqaCol; smacCol; fminconCol; fmincon_pureCol]/255;
  markers = {scmaesMark, dts005Mark, dts_adaptMark, maesMark, gpopMark, ...
      cmaesMark, cmaes2popMark, saacmesMark, lmmMark, bobyqaMark, smacMark, fminconMark, fmincon_pureMark};
