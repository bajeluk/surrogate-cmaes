...
% folder for results
actualFolder = pwd;
articleFolder = fullfile(actualFolder(1:end - 1 - length('src/surrogate-cmaes')), 'latex_scmaes', 'ec2016paper');
...
all_Ids = [scmaes_gp_Id, dts_adapt_Id, ...
    maes_Id, gpop_Id, cmaes_Id, ...
    cmaes2pop_Id, saacmes_Id, lmm_Id, bobyqa_Id, smac_Id, fmincon_pure_Id];
