...
%   speedUpPlot, speedUpPlotCompare, dataReady
  ...
  if length(data{1}) == 24
    ...
    groupNames = {'Oddělitelné funkce(f1-5)', ...
                'Málo nebo středně podmíněné funce(f6-9)', ...
                'Vysoce podmíněné funkce(f10-14)', ...
                'Vícemodální funkce(f15-19)', ...
                'Vícemodální funkce se slabou strukturou(f20-24)', ...
                'Všechny (f1-24)'};
  else
    fcnGroups = {101:106, 107:121, 122:130, 101:130};
    groupNames = {'Střední šum (f101-106)', ...
                'Velký šum (f107-121)', ...
                'Multimodální velký šum (f122-130)', ...
                'Všechny (f101-130)'};
  end
