...
FILES_TO_DEPLOY="exp/*.m exp/*.sh exp/experiments/*.m exp/util exp/log exp/vendor/bbob exp/vendor/saACMES src/ exp/pproc/generateGnuplot* Makefile startup.m ../copula-eda/exp/vendor/*"
