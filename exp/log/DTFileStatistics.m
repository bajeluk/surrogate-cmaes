    ...
    function notify(obj, ec, varargin)
      ...
      if (ec.cmaesState.countiter == 1 && ec.counteval <= (ec.cmaesState.lambda+1))
        ...
        fprintf(fid, ['#  iter  totEvals  orEvalsPop  Dopt  ' ...
            ...
            'adaptRankDiff  usedOrigRatio  nextOrigRatio  adaptGain  adaptNewRatio  ' ...
            'modelAge  trainSuccess  modelLikelihood  ' ...
      ...
      ...% mTyp nDa nDiR sgm^2
          '%d  %2d  %2d  %.2e  ' ...
      ...%rnkDf oRatT oRatN aGain aNeRat
          '%.2f  %.2f  %.2f  %.2f  %.2f  ' ...
      ...%mAg trOK mLik
          '%d  %d  %.2e  '...
      ...
      ...% mxDi  miDi  Drio  D_1,...,D_n
          ...
          ec.restrictedParam, ...
          ec.stats.adaptGain, ...
          ec.stats.adaptNewRatio, ... %%% newline
          ec.modelAge, ...
          ec.isTrainSuccess, ...
