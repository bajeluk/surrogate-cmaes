  ...
  methods
    ...
    function notify(obj, ec, varargin)
      ...
      %           #####  iter /evals(or,p) | Dopt |rmseR | rnkR | rnk2 |rnkVal * | Mo nD nDiR |sigm^2| aErr |smooEr| orRat| aGain|
        fprintf('####### iter /evals(or,p) | D_fopt. | rmseRee | rnkR | rnk2 | .rankErrValid. | M  nData | sigma^2. | aErr |smooEr| orRat| aGain|\n');
      end
      model = '.';
      nTrainData = 0;
      ...
      outputValues1 = [...
          ec.cmaesState.countiter, ec.counteval, sum(ec.pop.origEvaled)-ec.nPresampledPoints, ...
      ...
      %         #####  iter /evals(or,p) | Dopt |rmseR | rnkR | rnk2 |rnkVal * | Mo nD nDiR |sigm^2| aErr |smooEr| orRat| aGain|
      fprintf('=[DTS]= %4d /%5d(%2d,%1d) | %.1e | %.1e | %.2f | %.2f | %.2f %s | %s %2d/%3d | %.2e | %.2f | %.2f | %.2f | %.2f |\n', ...
