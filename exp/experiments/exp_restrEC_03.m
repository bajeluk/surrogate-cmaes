exp_id = 'exp_restrEC_03';
exp_description = 'Surrogate CMA-ES model using restricted individual EC with EI and low confidence bound in 2, 3, 5, 10D, version 3 -- double and 4-times larger popsize';
...
cmParamDef(1).values = {'(8 + floor(6*log(N)))', '(16 + floor(12*log(N)))'};
