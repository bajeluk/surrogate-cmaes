exp_id = 'exp_multiEC_02';
exp_description = 'Surrogate CMA-ES model using Multi-trained EC version 2 with single population and NArchivePoints = 10*dim, 5*dim and floor(2*dim^1.8) == [6,36,126], NOrigInit = 1, n_b = 1/2, RankErrorThresh = 0.1; in 2D, 5D, and 10D';
...
surrogateParams = { ...
  ...
  'evoControlTrainNArchivePoints', { '10*dim', '5*dim', 'floor(2*dim^1.8)' },... % will be myeval()'ed, 'nRequired', 'nEvaluated', 'lambda', 'dim' can be used
