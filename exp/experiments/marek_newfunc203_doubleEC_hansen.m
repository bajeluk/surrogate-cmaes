...
exp_id = 'marek_newfunc203_doubleEC_hansen';
exp_description = 'DTS-CMA-ES with fvalues criterion and hansen model, f203 in [3, 9, 12, 15, 21]D, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
