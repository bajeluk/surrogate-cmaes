...
exp_id = 'marek_newfunc201_doubleEC_gp_fvalues';
exp_description = 'DTS-CMA-ES with fvalues criterion, f201 in [4, 8, 12, 16, 20]D, Surrogate CMA-ES, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
