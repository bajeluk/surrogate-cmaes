exp_id = 'exp_geneEC_gptrain1_10D';
exp_description = 'Surrogate CMA-ES model, GP model training experiment';
...
bbParamDef(2).values = {2, 3, 8, 11}; % num2cell(1:24);  % {1, 2, 3, 5, 6, 8, 10, 11, 12, 13, 14, 20, 21};
...
bbParamDef(4).values = {[1:5 41:42], [43:50]}; % 31:40]};   % default is [1:5, 31:40]
