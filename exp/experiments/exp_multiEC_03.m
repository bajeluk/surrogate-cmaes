exp_id = 'exp_multiEC_03';
exp_description = 'Surrogate CMA-ES model using Multi-trained EC version 2 with single and double population and NArchivePoints = 15*dim, NOrigInit = 1, RankErrorThresh = 0.1; in 2D, 5D, and 10D';
