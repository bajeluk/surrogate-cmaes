exp_id = 'exp_maesEC_07_10D';
exp_description = 'Model Assisted Evolution Strategy (Ulmer, 2003), GP model, CMA-ES with default (mu, lambda), individual EC, 3*lambda pre-selection, 2*lambda training points, POI or mean prediction, 24 functions, 15 instances, maxfunevals 250 * dim';
...
modelParams = { ...
  ...
  'hyp',                  { struct( ...
                              'lik', log(0.001), ...
                              'cov', 'log([0.5 * ones(dim, 1); 0.1; 0.1; 1e-4])' ... % ell, signal variance, signal noise
                            ), ...
                          }, ...
