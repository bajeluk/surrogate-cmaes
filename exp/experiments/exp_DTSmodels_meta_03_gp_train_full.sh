#!/bin/bash
#
# Job-submitting experiment for 8 GP model settings testing
# on TSS nearest selected from dataset DTS_meta_005_train.mat.
#
# It is expected to be located in exp/experiments/

export EXPID='exp_DTSmodels_meta_03_gp_train_full'
...
Q5D="96:00:00"
Q10D="168:00:00"
QND="336:00:00" # other dimensions (e.g., 20D)

INST="[11 12 13 14 15]"
IDS="[1 2 3 4 5 6 7]" # IDS in DTS_meta_005_train were selected at random from DTS_meta_005
echo "exp/metacentrum_lish.sh -en $EXPID {1..960}"
FAILED_LINE=`exp/metacentrum_list.sh -en $EXPID {1..960}`
