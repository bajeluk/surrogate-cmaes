exp_id = 'Copy5_of_exp_doubleEC_26_1model';
...
bbobParams = { ...
  'dimensions',         { 4 }, ...
  'functions',          num2cell(205:205), ...      % all functions: num2cell(1:24)
  'opt_function',       { @opt_s_cmaes }, ...
  'instances',          { [355:355] }, ...    % default is [1:5, 41:50]
  'maxfunevals',        { '500' }, ...
  'resume',             { true }, ...
};
...
surrogateParams = { ...
  ...
  'modelType',          { 'lmm' }, ...               % 'gp', 'rf', 'bbob, 'reg', 'lmm'
  ...
  'evoControlTrainNArchivePoints', { '150*dim' },... % will be myeval()'ed, 'nRequired', 'nEvaluated', 'lambda', 'dim' can be used
