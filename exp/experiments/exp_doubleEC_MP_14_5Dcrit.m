exp_id = 'exp_doubleEC_MP_14_5Dcrit';
exp_description = 'DTS-CMA-ES with ERDE, f-values, EI and PoI criteria, 1 final settings of ModelPool: w/o ARD, and w/o meanLinear, in 5D, Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop';
