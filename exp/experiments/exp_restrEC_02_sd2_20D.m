exp_id = 'exp_restrEC_02_sd2_20D';
exp_description = 'Surrogate CMA-ES model using restricted individual EC with sd2 criterion (maximal variance) in 20D';
...
sgParamDef(13).values = {0.1, 0.2, 0.3, 0.4};
