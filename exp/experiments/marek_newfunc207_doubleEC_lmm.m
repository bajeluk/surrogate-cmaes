...
exp_description = 'DTS-CMA-ES with fvalues criterion and local meta model, f207 in [2, 4, 10, 12, 16, 20]D, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
