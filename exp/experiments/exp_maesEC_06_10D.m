exp_id = 'exp_maesEC_06_10D';
exp_description = 'Model Assisted Evolution Strategy (Ulmer, 2003), GP model, CMA-ES with default (mu, lambda), individual EC, 3*lambda pre-selection, 2*lambda training points, POI or mean prediction, 24 functions, 15 instances';
