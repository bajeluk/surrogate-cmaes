exp_id = 'exp_maesEC_05_2_10_cmaes_10D';
exp_description = 'Model Assisted Evolution Strategy (Ulmer, 2003), GP model, (2,10) CMA-ES, individual EC, 3*lambda pre-selection, 2*lambda training points, POI or mean prediction, 24 functions, 15 instances';
