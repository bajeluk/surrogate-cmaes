...
exp_id = 'exp_preciseModel_indi01';
exp_description = 'Surrogate CMA-ES with totally precise model';

machines = { 'u-pl5', 'u-pl6', 'u-pl7', 'u-pl8', 'u-pl9', 'u-pl10', 'u-pl11', 'u-pl12', 'u-pl13', 'u-pl14', 'u-pl15', 'u-pl16', 'u-pl17', 'u-pl18', 'u-pl19'};
login = 'bajel3am';
...
bbParamDef(1).values = {2, 5};      % {2, 5 10};
...
sgParamDef(4).values = {10, 20};
sgParamDef(5).name   = 'evoControlBestFromExtension';
sgParamDef(5).values = {0.1, 0.2, 0.4, 0.6};
sgParamDef(6).name   = 'evoControlTrainRange';
sgParamDef(6).values = {4, 8, 16}; % {2, 3, 4, 6, 8};

sgParamDef(7).name   = 'evoControlOrigGenerations';
sgParamDef(7).values = {1};
sgParamDef(8).name   = 'evoControlModelGenerations';
sgParamDef(8).values = {4};
sgParamDef(9).name   = 'evoControlValidatePoints';
