...
modelOptions = struct( ...
  ...
  'params', { ...
    ...
    struct( ...   % SE + LIN
      ...
      'hyp',      struct('lik', log(0.01), 'cov', log([1 1 1 1 1])), ...
      'prior',    struct('lik', {{pg1}}, 'cov', {{pt1 pt1 pt1 pt1 pt1}}) ...
    ) ...
  } ...
);
% 
...
modelParams = { ...
  ...
  'sharedModelOptions', { ...
    struct( ...
      ...
      'centerX',            { true }, ...
      'trainAlgorithm',     { 'mcmc' }, ...
      'mcmcNSimu',          { 'max(500, 10 * obj.nHyp ^ 2)' }, ...
      'mcmcBurnin',         { 'obj.mcmcNSimu' }, ...
      'mcmcNChains',        { 2 }, ...
      'predictFullPost',    { false }, ...
      'bayesEstFcn',        { 'median' }, ...
      'nSimuPost',          { 'max(100, 50 * obj.nHyp)' } ...
    ) ...
  }, ...
  'ic',                 { 'waic2' }, ...
