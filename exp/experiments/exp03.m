...
exp_id = 'exp03';
exp_description = 'Surrogate CMA-ES on 2,5,10,20,40D - first GP and RF models, basic settings';

machines = {'u-pl22', 'u-pl23', 'u-pl24', 'u-pl25', 'u-pl26', 'u-pl27', 'u-pl28'};
login = 'bajel3am';
if (strfind(exp_id, 'afs'))
...
bbParamDef(1).values = {2, 5, 10, 20, 40};      % {2, 5 10};
...
sgParamDef(6).values = {4, 6, 10}; % {2, 3, 4, 6, 8};
