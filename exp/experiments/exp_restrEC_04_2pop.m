exp_id = 'exp_restrEC_04_2pop';
exp_description = 'Surrogate CMA-ES model using restricted individual EC with sd2 criterion and GPs with double-population, (a) f-value normalization (b) non-normalized; GPs with improved performance';
