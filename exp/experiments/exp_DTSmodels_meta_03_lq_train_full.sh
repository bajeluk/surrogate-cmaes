#!/bin/bash
#
# Job-submitting experiment for lq model setting testing
# on TSS full selected from dataset DTS_meta_005_train.mat.
#
# It is expected to be located in exp/experiments/

export EXPID='exp_DTSmodels_meta_03_lq_train_full'
...
Q5D="2:00:00"
Q10D="2:00:00"
QND="2:00:00" # other dimensions (e.g., 20D)
