...
exp_description = 'DTS-CMA-ES with fvalues criterion and local meta model, f206 in 2D, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
