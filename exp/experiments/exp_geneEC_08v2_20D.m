exp_id = 'exp_geneEC_08v2_20D';
exp_description = 'Surrogate CMA-ES model, GP and RF + rebase, generation EC, 24 functions, 15 instances -- second production test to BBOB workshop paper';
