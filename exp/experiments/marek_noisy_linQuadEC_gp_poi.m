% Experiment testing lq-CMA-ES using GP with PoI criterion, noisy in [2,3,5,10,20]D, PreSampleSize=0.75, 2pop
% Original experiment: marek_linQuadEC_gp
exp_id = 'marek_noisy_linQuadEC_gp_poi';
exp_description = 'lq-CMA-ES using GP with PoI criterion, noisy in [2,3,5,10,20]D, PreSampleSize=0.75, 2pop';
