...
exp_id = 'marek_noisy_doubleEC_hansen';
exp_description = 'DTS-CMA-ES with fvalues criterion and hansen model, noisy in [2,3,5,10,20]D, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
