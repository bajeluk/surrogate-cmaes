...
exp_id = 'marek_newfunc204_doubleEC_gp';
exp_description = 'DTS-CMA-ES with PoI criterion, f204 in [4, 10, 13, 16, 19]D, Surrogate CMA-ES, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
