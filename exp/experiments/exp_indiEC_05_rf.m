...
exp_id = 'exp_indiEC_05_rf';
exp_description = 'Surrogate CMA-ES model, RF model, individual EC';

machines = {'u-pl16', 'u-pl17', 'u-pl18', 'u-pl19', 'u-pl20', 'u-pl21', 'u-pl22', 'u-pl23', 'u-pl24', 'u-pl25', 'u-pl26'};
...
bbParamDef(2).values = {1, 2, 3, 5, 6, 8, 10, 20, 21};
...
sgParamDef(3).values = { 0.25, 0.5 };     % {0.25, 0.5, 0.75};
