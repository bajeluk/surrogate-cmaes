% Experiment testing lq-CMA-ES using GP with PoI criterion, f207 in [2,3,5,10,20]D, PreSampleSize=0.75, 2pop
%Original experiment: exp_doubleEC_26_1model
exp_id = 'marek_newfunc207_linQuadEC_gp_poi';
exp_description = 'lq-CMA-ES using GP with PoI criterion, f207 in [2, 4, 10, 12, 16, 20]D, PreSampleSize=0.75, 2pop';
