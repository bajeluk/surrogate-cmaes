...
exp_id = 'marek_newfunc206_doubleEC_gp_fvalues';
exp_description = 'DTS-CMA-ES with fvalues criterion, f206 in 2D, Surrogate CMA-ES, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
