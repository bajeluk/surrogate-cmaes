...
exp_description = 'Surrogate CMA-ES model using Multi-trained EC with sd2 criterion and GPs with single population, NOrigInit = 1, RankErrorThresh = 0.1; in 5D';

% BBOB/COCO framework settings

bbobParams = { ...
  'dimensions',         { 5 }, ...
  'functions',          { 1, 2, 3, 8, 12 }, ...      % all functions: num2cell(1:24)
...
cmaesParams = { ...
  'PopSize',            { '(3 + floor(3*log(N)))' }, ...        %, '(8 + floor(6*log(N)))'};
  'Restarts',           { 50 }, ...
};
