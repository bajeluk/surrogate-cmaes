...
exp_description = 'DTS-CMA-ES with fvalues criterion and local meta model, in [2,3,5,10,20]D, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
