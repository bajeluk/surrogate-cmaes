% Experiment testing lmm-CMA-ES using GP with PoI criterion, noisy in [2,3,5,10,20]D, PreSampleSize=0.75, 2pop
%Original experiment: exp_doubleEC_26_1model
exp_id = 'marek_noisy_lmmEC_gp_poi';
exp_description = 'lmm-CMA-ES with GP using PoI criterion, noisy in [2,3,5,10,20]D, PreSampleSize=0.75, 2pop';
