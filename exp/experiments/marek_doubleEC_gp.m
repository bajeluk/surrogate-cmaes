...
exp_id = 'marek_doubleEC_gp';
exp_description = 'DTS-CMA-ES with PoI criterion, in [2,3,5,10,20]D, Surrogate CMA-ES, adaptive default DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
