exp_id = 'exp_restrEC_03_20D';
exp_description = 'Surrogate CMA-ES model using restricted individual EC with EI and low confidence bound in 20D, version 3 -- double and 4-times larger popsize';
