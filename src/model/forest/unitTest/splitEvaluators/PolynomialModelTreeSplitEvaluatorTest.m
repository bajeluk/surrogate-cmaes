classdef PolynomialModelTreeSplitEvaluatorTest < matlab.unittest.TestCase
  methods (Test)
    ...
    function testLinearNoGain(testCase)
      ...
      evaluator = PolynomialModelTreeSplitEvaluator(@gainMse, 'linear');
      evaluator.reset(X, y);
    ...
    function testQuadraticGainOnQuadraticFunction(testCase)
      ...
      evaluator = PolynomialModelTreeSplitEvaluator(@gainMse, 'quadratic');
      evaluator.reset(X, y);
