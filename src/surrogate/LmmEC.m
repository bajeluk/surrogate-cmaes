classdef LmmEC < EvolutionControl & Observable
%
% TODO:
...
%
  ...
  methods
    function obj = LmmEC(surrogateOpts, varargin)
    % constructor
      obj@Observable();
      obj.pop = [];
      obj.counteval = 0;
    ...
    % Run one generation of local meta model evolution control
      ...
      obj.nB = max(ceil(lambda/20), 1);
      obj.qualityThreshhold = (lambda*lambda) / 20;
