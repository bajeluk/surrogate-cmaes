...
MC_INCLUDE= -a exp/opt_cmaes.m -a exp/opt_s_cmaes.m -a exp/util -a exp/vendor/bbob -a src -a exp/log -a ../copula-eda/exp/vendor/ -a exp/opt_CEDA.m -a exp/opt_EGNA.m -a exp/opt_GaussianEDA.m
SRC = exp/$(FNAME).m
